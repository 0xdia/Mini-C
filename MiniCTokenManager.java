...
static private int jjMoveStringLiteralDfa0_0()
{
   switch(curChar)
   {
      ...
      case 47:
         return jjStartNfaWithStates_0(0, 37, 11);
      case 59:
...
static final int[] jjnextStates = {
   12, 13, 15, 0, 1, 3, 11, 16, 18, 19, 21, 4, 5, 1, 6, 2, 
   3, 5, 8, 9, 11, 
};

/** Token literal values. */
public static final String[] jjstrLiteralImages = {
"", null, null, null, null, null, null, "\75", "\74", "\76", "\74\75", 
"\76\75", "\41\75", "\75\75", "\151\146", "\151\156\164", "\146\157\162", 
"\146\154\157\141\164", "\145\154\163\145", "\167\150\151\154\145", null, null, null, null, null, null, 
null, null, "\50", "\51", "\54", "\73", "\173", "\175", "\53", "\55", "\52", "\57", };
...
static void TokenLexicalActions(Token matchedToken)
{
   switch(jjmatchedKind)
   {
      ...
      case 25 :
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
         matchedToken.kind = ASSIGN; matchedToken.image = "=";
         break;
      case 26 :
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
        matchedToken.kind = IDENTIFIER; matchedToken.image = tmp_id;
         break;
      case 27 :
        image.append(input_stream.GetSuffix(jjimageLen + (lengthOfMatch = jjmatchedPos + 1)));
         matchedToken.kind = EQUAL; matchedToken.image = "==";
         break;
      default :
         break;
   }
